<template>
  <div class="p-grid p-fluid dashboard">
    <div class="dashboard_section_1">
      <div class="p-col-12 p-lg-4" style="width: 100%">
    ...
    <div class="dashboard_section_1">
      <div class="p-col-12 p-md-6 p-xl-3" style="width: 100%">
    ...
    <div
      class="dashboard_section_1"
      style="margin-top: 1rem; align-items: start"
    >
      <div class="p-col-12 p-md-6 p-lg-4" style="width: 100%">
        <Panel header="Tasks">
          <ul class="task-list">
            <li>
    ...
    <div
      ...
      style="margin-top: 1rem; align-items: start"
    >
      <div class="p-col-12 p-lg-6" style="width: 100%">
        <div class="card">
